/*
 * sound\soc\sunxi\audiocodec\sun50iw2p1_codec.h
 * (C) Copyright 2010-2016
 * Allwinner Technology Co., Ltd. <www.allwinnertech.com>
 * Young <guoyingyang@allwinnertechtech.com>
 *
...
#ifndef _SUN50IW2P1_CODEC_H
#define _SUN50IW2P1_CODEC_H
/*Codec Register*/
...
#define LINEOUT_PA_GAT			  	  (0x00 + ANALOG_FLAG)
#define LOMIXSC					  (0x01 + ANALOG_FLAG)
#define ROMIXSC					  (0x02 + ANALOG_FLAG)
#define DAC_PA_SRC				  (0x03 + ANALOG_FLAG)
#define LINEIN_GCTR				  (0x05 + ANALOG_FLAG)
#define MIC_GCTR				  (0x06 + ANALOG_FLAG)
#define PAEN_CTR				  (0x07 + ANALOG_FLAG)
#define LINEOUT_VOLC			  	  (0x09 + ANALOG_FLAG)
#define MIC2G_LINEOUT_CTR		  	  (0x0A + ANALOG_FLAG)
...
#define ADDA_APT2				  (0x12 + ANALOG_FLAG)
#define BIAS_DA16_CTR0			  	  (0x13 + ANALOG_FLAG)
#define BIAS_DA16_CTR1			  	  (0x14 + ANALOG_FLAG)
#define DA16CAL					  (0x15 + ANALOG_FLAG)
#define DA16VERIFY				  (0x16 + ANALOG_FLAG)
#define BIASCALI				  (0x17 + ANALOG_FLAG)
#define BIASVERIFY				  (0x18 + ANALOG_FLAG)
