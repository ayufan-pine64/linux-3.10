...
struct factor_init_data sunxi_factos[] = {
	...
	{"pll_video",   hosc_parents, 1,          CLK_IGNORE_DISABLE,                        PLL_VIDEO,   PLL_VIDEO,   LOCKBIT(28), PLL_CLK_CTRL,     2,          PLL_LOCK_NONE_MODE, &sunxi_clk_factor_pll_video,   &get_factors_pll_video,   &calc_rate_media,      (struct clk_ops *)NULL},
	...
	{"pll_ddr",     hosc_parents, 1,          CLK_IGNORE_DISABLE | CLK_GET_RATE_NOCACHE, PLL_DDR,     PLL_DDR,     LOCKBIT(28), PLL_CLK_CTRL,     4,          PLL_LOCK_NONE_MODE, &sunxi_clk_factor_pll_ddr,     &get_factors_pll_ddr,     &calc_rate_pll_ddr,    (struct clk_ops *)NULL},
